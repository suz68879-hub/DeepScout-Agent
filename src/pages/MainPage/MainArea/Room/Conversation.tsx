...
function Conversation(props: React.HTMLAttributes<HTMLDivElement> & { showSubtitle: boolean; standalone?: boolean }) {
  const { className, showSubtitle, standalone = false, ...rest } = props;
  ...
  return (
    <div
      ref={containerRef}
      className={`${styles.conversation} ${standalone ? styles.standalone : ''} ${className ?? ''} ${isFullScreen ? styles.fullScreen : ''} ${
