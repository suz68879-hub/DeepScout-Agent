...
const UNKNOWN_NETWORK_QUALITY = 0 as NetworkQuality;
...
const initialState: RoomState = {
  ...
  isAITalking: false,
  isUserTalking: false,
  networkQuality: UNKNOWN_NETWORK_QUALITY,
...
export const roomSlice = createSlice({
  ...
  reducers: {
    ...
    updateRTCConfig: (state, { payload }) => {
      ...
      // 副作用（写入 rtcEngine.basicInfo）已移至 store listener middleware（架构纠偏 §4.3）
    },
